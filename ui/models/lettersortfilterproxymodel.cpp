#include "lettersortfilterproxymodel.h"

LetterSortFilterProxyModel::LetterSortFilterProxyModel()
{

}

bool LetterSortFilterProxyModel::filterAcceptsRow(int sourceRow, const QModelIndex &sourceParent) const
{
